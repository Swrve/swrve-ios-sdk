...
- (ISHPermissionState)permissionState {
    ...
    UIUserNotificationSettings *currentNoticationSettings = [[UIApplication sharedApplication] currentUserNotificationSettings];
    if (!currentNoticationSettings || (currentNoticationSettings.types == UIUserNotificationTypeNone)) {
