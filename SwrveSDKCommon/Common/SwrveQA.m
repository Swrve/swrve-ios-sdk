...
static NSString * const LOCATION_SDK = @"location-sdk";
...
-(NSMutableDictionary*)locationCampaignTriggered:(NSArray*)campaigns  {
    ...
    NSMutableDictionary* qaLog = [@{LOG_TYPE:@"location-campaign-triggered", LOG_SOURCE:LOCATION_SDK}  mutableCopy];
...
-(NSMutableDictionary*)locationCampaignDownloaded:(NSDictionary*)campaignsDic  {
    ...
    NSMutableDictionary* qaLog = [@{LOG_TYPE:@"location-campaigns-downloaded", LOG_SOURCE:LOCATION_SDK}  mutableCopy];
...
-(NSMutableDictionary*)locationCampaignEngagedID:(NSString*)campaignID variantID:(NSNumber*)variantID plotID:(NSString*)plotID payload:(NSDictionary*)payload  {
    ...
    NSMutableDictionary* qaLog = [@{LOG_TYPE:@"location-campaign-engaged", LOG_SOURCE:LOCATION_SDK}  mutableCopy];
