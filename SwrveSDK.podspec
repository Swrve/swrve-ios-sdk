Pod::Spec.new do |s|
  ...
  s.dependency 'SwrveSDKCommon', '4.10.2'
  s.dependency 'SwrveConversationSDK', '4.10.2'
  ...
  s.weak_frameworks = 'Contacts', 'Photos', 'AssetsLibrary', 'AddressBook', 'UserNotifications', 'UserNotificationsUI'
  s.library = 'sqlite3'
end
