Pod::Spec.new do |s|
  ...
  s.source_files = 'SwrveSDKCommon/Common/**/*.{m,h}', 'SwrveConversationSDK/Conversation/**/*.{m,h}', 'SwrveSDK/SDK/**/*.{m,h}'
  s.public_header_files = 'SwrveSDKCommon/Common/**/*.h', 'SwrveConversationSDK/Conversation/**/*.h', 'SwrveSDK/SDK/**/*.h'
