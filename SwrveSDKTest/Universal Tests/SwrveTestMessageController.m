...
- (void)testJsonParser {
    ...
    XCTAssertEqual([[format buttons] count], 3);
    ...
    XCTAssertEqualObjects([button1 controller], controller);
    ...
    XCTAssertEqualObjects([button2 controller], controller);
    ...
    SwrveButton* button3 = [[format buttons] lastObject];
    ...
    XCTAssertEqualObjects([button3 controller], controller);
...
- (void)testCustomButtonPressed {
    ...
    // Pretend to press custom button
